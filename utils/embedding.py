...
def create_dataset(path):
    ...
    train_data = pd.DataFrame(train_text, columns=['Original', 'Edited', 'Masked', 'Mean_Score'])
    test_data = pd.DataFrame(test_text, columns=['Original', 'Edited', 'Masked', 'Mean_Score'])
